...
def analyze(input):
    ...
    client = redis.from_url('redis://:p05ca3a5a99da6bbd8bd06cd80912e4f89710bcc2149d75a64c645485ae85d9eb@ec2-174-129-249-71.compute-1.amazonaws.com:9029')
    ...
    for entity in response.entities:
        if client.hexists('cryptos', entity.name):
            ...
            coinSentiment.append(CoinSentiment(coin.decode("utf-8") if type(coin) != str else coin, entity.sentiment.score))


    for coin in coinSentiment:
        print(coin.coin, coin.sentiment)
